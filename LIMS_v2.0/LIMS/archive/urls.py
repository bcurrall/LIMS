...
urlpatterns =[
    ...
    #new 01_10_19
    url(r'^add_full_sample2_single/$', views.add_full_sample2_single, name='add_sample2_single'),
    url(r'^add_sample2_multiple/$', views.add_sample2_multiple, name='add_sample2_multiple'),
