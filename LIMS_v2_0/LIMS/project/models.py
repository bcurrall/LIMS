...
class PI(models.Model):
    # choices
    # fields
    name = models.ForeignKey(Personnel, on_delete=models.PROTECT, null=True, blank=True)
...
class Project(models.Model):
    ...
    lead_pi = models.ForeignKey(PI, on_delete=models.PROTECT, null=True, blank=True)
    lead_driver = models.ForeignKey(Driver, on_delete=models.PROTECT, null=True, blank=True)
    lead_comp_anlyst = models.ForeignKey(CompAnalyst, on_delete=models.PROTECT, null=True, blank=True)
    lead_lab_anlyst = models.ForeignKey(LabAnalyst, on_delete=models.PROTECT, null=True, blank=True)
    lead_tech = models.ForeignKey(Tech, on_delete=models.PROTECT, null=True, blank=True)
...
class PO(models.Model):
    ...
    # fields
    name = models.CharField(max_length=50)
    funding = models.ForeignKey(Funding, on_delete=models.PROTECT, null=True, blank=True)
