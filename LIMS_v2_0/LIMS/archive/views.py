...
def add_sample_basic(request):
    title = 'Enter Basic Samples Information'
    basic_url = 'add_sample_basic'
    advanced_url = 'base'
    extras = 5
    pks = list()
    ...
    if "export_btn" in request.POST:
        ...
        columns = ['sample_name', 'type', 'conc', 'vol']
    ...
    if "upload_btn" in request.POST:
        ...
        if upload_form.is_valid():
            ...
            for record in data:
                ...
                sample_record = Individual.objects.get_or_create(name=sample_name)
    ...
    if "save_btn" in request.POST:
        ...
        for form in p_formset:
            if form.is_valid():
                ...
                pks.append(pk)
        return HttpResponseRedirect('/archive/browse_sample')
